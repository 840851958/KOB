            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-success float-end" data-bs-toggle="modal" data-bs-target="#add_bot_btn">
                            创建一个Bot
                        </button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea v-model="botadd.description" class="form-control" id="add-bot-description" rows="5" placeholder="请输入Bot简介"></textarea>
                                        </div>
                                        <div class="mb-3">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea v-model="bot.description" class="form-control" id="update-bot-description" rows="5" placeholder="请输入Bot简介"></textarea>
                                                        </div>
                                                        <div class="mb-3">
    ...
    setup() {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                ...
                // 放行的url不需要加，其余都需要验证身份，放行的url自己定义在后端
                headers: {
                    Authorization: "Bearer " + store.state.user.token,
                },
                success(resp){
